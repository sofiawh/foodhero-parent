...
public class EnrollmentController {
    ...
    @PostMapping
    public ResponseEntity<UserProfile> enrollUser(@RequestBody UserProfile enrollment) {
    ...
    @GetMapping
    public ResponseEntity<List<UserProfile>> getEnrollments() {
        List<UserProfile> enrolleds = service.findAllEnrollments();
        return ResponseEntity.ok(enrolleds);
    }

    @PutMapping("/{enrollmentId}")
    public ResponseEntity<UserProfile> updateEnrollment(@PathVariable Long enrollmentId, @RequestBody UserProfile updatedEnrollment) {
        UserProfile enrollment = service.updateEnrollment(enrollmentId, updatedEnrollment);
